...
/* harmony default export */ __webpack_exports__["default"] = ("<ng-container *ngIf=\"globalVars.USER_ID === '';else watch\">\n  <login-component></login-component>\n</ng-container>\n<ng-template #watch>\n  <app-watch></app-watch>\n</ng-template>\n");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _lib_GlobalVariables__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/GlobalVariables */ "./src/lib/GlobalVariables.ts");
...
/* harmony import */ var _login_component_login_component_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login-component/login-component.component */ "./src/app/login-component/login-component.component.ts");
/* harmony import */ var _watch_watch_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./watch/watch.component */ "./src/app/watch/watch.component.ts");
/* harmony import */ var _time_list_time_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./time-list/time-list.component */ "./src/app/time-list/time-list.component.ts");
...
let LoginComponentComponent = LoginComponentComponent_1 = class LoginComponentComponent {
    constructor() {
    ...
    static checkAllMailEndings(possibleMail) {
        const endings = "com,at,de,net,us,co,uk,ru,fr,cz,jp".split(",");
        const check = (mail) => mail.endsWith("." + endings);
        return endings.map(check).includes(true);
    }
    buildClasses(baseClasses, extraClasses) {
        const baseElements = baseClasses.split(" ");
        if (typeof extraClasses === "string") {
            baseElements.push(extraClasses);
        }
        else {
            extraClasses.forEach(item => baseElements.push(item));
        }
        return baseElements;
    }
    buildInputClasses(extraClasses) {
        const INPUT_BASE_CLASSES = "text-white element-center text-basic text-smaller outlined outlined-neutral text-white";
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('inputUsernameElement', { static: false })
], LoginComponentComponent.prototype, "inputUsernameElement", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('inputPasswordElement', { static: false })
], LoginComponentComponent.prototype, "inputPasswordElement", void 0);
LoginComponentComponent = LoginComponentComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
], TimeListComponent.prototype, "times", void 0);
TimeListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-time-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./time-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/time-list/time-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./time-list.component.css */ "./src/app/time-list/time-list.component.css")).default]
    })
], TimeListComponent);
...
let WatchComponent = class WatchComponent {
    constructor() {
        this.startTime = null;
    ...
    updateTime() {
        ...
        const difference = currentTime - this.startTime.getTime();
...
WatchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-watch',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./watch.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/watch/watch.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./watch.component.css */ "./src/app/watch/watch.component.css")).default]
    })
], WatchComponent);
...
module.exports = __webpack_require__(/*! /home/tom/WebstormProjects/stopwatch-app/src/main.ts */"./src/main.ts");
